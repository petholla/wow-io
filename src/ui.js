...
export function addRefreshSection(changeFunction) {
    const refreshDiv = document.getElementById("refreshDiv");
    ...
    const refreshHeader = document.createElement("th");
    refreshHeader.className = "rounded";
    refreshHeader.innerText = "Auto refresh";
    headerRow.appendChild(refreshHeader);
    const refreshIn = document.createElement("th");
    refreshIn.className = "rounded";
    refreshIn.innerText = "Refresh in";
    headerRow.appendChild(refreshIn);
    ...
    refreshSelector.addEventListener("change", changeFunction);
    const textNode = document.createTextNode(" minutes");
